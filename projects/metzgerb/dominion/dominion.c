...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurer_effect(currentPlayer, state);
...
int ambassador_effect(int choice1, int choice2, int currentPlayer, struct gameState* state, int handPos)
{
	...
	{
		printf("i=%d, handpos=%d, choosencard=%d, icard=%d\n", i, handPos, state->hand[currentPlayer][choice1], state->hand[currentPlayer][i]);
